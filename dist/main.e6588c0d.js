...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/main.jsx":[function(require,module,exports) {
  ...
  return {
    ...
    props: _objectSpread(_objectSpread({}, props), {}, {
      children: children.map(function (item) {
        return _typeof(item) === "object" ? item : createTextNode(item);
      })
    })
  };
};
...
var createDom = function createDom(element) {
  ...
  if (isDomElement) {
    var isTextElement = type === "TEXT";
    dom = isTextElement ? document.createTextNode(props.nodeValue) : document.createElement(type);
    Object.keys(props).filter(isEvent).forEach(function (name) {
      var eventType = name.toLowerCase().substring(2);
      dom.addEventListener(eventType, props[name]);
    });
    children.map(function (child) {
      return dom.appendChild(createDom(child));
    });
    return dom;
  } else {
    var _element = type(props);

    return createDom(_element);
  }
};

var render = function render(element, container) {
  var dom = createDom(element);
...
var React = {
  ...
  useState: function useState(initialValue) {
    ...
    var currentStatePair = this.stateArr[this.currentStateIndex];
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","src/main.jsx"], null)
//# sourceMappingURL=/main.e6588c0d.js.map